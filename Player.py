...
song_frame = LabelFrame(
    root, text="Current Song", bg="purple", fg="white", width=400, height=80
)
song_frame.place(x=0, y=0)

button_frame = LabelFrame(
    root, text="Control Buttons", bg="purple", fg="white", width=400, height=120
)
button_frame.place(y=80)

listbox_frame = LabelFrame(root, text="Playlist", bg="purple", fg="white")
...
playlist = Listbox(
    listbox_frame,
    font=("Helvetica", 11),
    selectbackground="medium purple",
    bg="black",
    fg="white",
)
